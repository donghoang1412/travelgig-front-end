...
import EachCompleteViewContainer from "../EachCompleteViewComponent/EachCompleteViewContainer"
export default function CompleteViewView(props) {
    const {
        customerMobile
    } = props
