...
import EachCancelledViewContainer from "../EachCancelledViewComponent/EachCancelledViewContainer"
import "./CancelledView.css"
export default function CancelledViewView(props) {
    const {
        customerMobile
    } = props
